			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-xs-6">
							...
							<h2></h2>
							<a href = "thuong-hieu/tao-moi" class="btn btn-success"><i class="material-icons">&#xE147;</i><h5 style="font-size: 15px">Tạo sản phẩm</h5></a>
				...
				<table class="table table-striped table-hover">
					...
					<c:forEach var = "item" items = "${trademarks}">
							...
							<td>${item.url}</td>
							<td>
								<a href="thuong-hieu/update/${item.id}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
								<a href="thuong-hieu/delete/${item.id}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
							</td>
						</tr>
					</c:forEach>
					</tbody>
