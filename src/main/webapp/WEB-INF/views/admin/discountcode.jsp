			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-xs-6">
							...
							<h2></h2>
							<a href = "ma-giam-gia/tao-moi" class="btn btn-success"><i class="material-icons">&#xE147;</i><h5 style="font-size: 15px">Tạo sản phẩm</h5></a>
				...
				<table class="table table-striped table-hover">
					...
					<c:forEach var = "item" items = "${discountcodes}">
							...
							<td>
								<a href="ma-giam-gia/update/${item.id}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
								<a href="ma-giam-gia/delete/${item.id}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
							</td>
						</tr>
					</c:forEach>
					</tbody>
