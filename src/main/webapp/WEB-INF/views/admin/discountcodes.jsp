		...
		<div class="table-responsive">
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-xs-6">
							<h2>Tất Cả <b>Mã giảm giá</b></h2>
							<a href = "discount-management/tao-moi" class="btn btn-success"><i class="material-icons">&#xE147;</i><h5 style="font-size: 15px">Tạo mã giảm giá</h5></a>
							<a href = "discount-management/delete" class="btn btn-danger"><i class="material-icons">&#xE147;</i><h5 style="font-size: 15px"> Xóa mã giảm giá</h5></a>
							<a href = "discount-management/update" class="btn btn-success"><i class="material-icons">&#xE147;</i><h5 style="font-size: 15px">Cập nhật mã giảm giá</h5></a>
							<a href = "discount-management/search" class="btn btn-danger"><i class="material-icons">&#xE147;</i><h5 style="font-size: 15px"> Tìm kiếm mã giảm giá</h5></a>
						</div>
					</div>
				</div>
