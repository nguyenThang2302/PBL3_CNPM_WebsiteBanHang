				...
				<form method = "post" action = "add">>
					<div class="modal-header">						
 					...
 					<div class="modal-body">
						...
						<div class="form-group">
							<label>Hình ảnh thuơng hiệu</label>
							<input name="image" type="text" class="form-control" required = "required"/>
						</div>
						<div class="form-group">
							<label>URL thương hiệu</label>
							<input name="url" type="text" class="form-control" required = "required"/>
						</div>		
					</div>  
					<div class="modal-footer">
						<a href="/spring-mvc/thuong-hieu" type="button" class="btn btn-default" data-dismiss="modal">Cancel</a>
