<%@ page language="java" contentType="text/html; charset=UTF-8"
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            ...
                            <li>Email: pbl3_cnpm@gmail.com</li>
                        </ul>
                    </div>
                </div>
  ...
  Sản phẩm &copy;<script>document.write(new Date().getFullYear());</script> Thuộc quyền sở hữu bởi | NVT-NQS-LQA <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://www.facebook.com/thang.230203" target="_blank">PBL3 Công Nghệ Phần Mềm</a>
