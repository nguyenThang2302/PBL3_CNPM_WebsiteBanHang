...
<head>
    ...
    <!-- Vendor CSS Files -->
	  ...
	  <link href="<c:url value='/template/web/assets/vendor/aos/aos.css'/>"  rel="stylesheet">
...
<body>
    ...
    <script type="text/javascript"></script>
      ...
      <!-- Vendor JS Files -->
	  <script src="<c:url value='/template/web/assets/vendor/aos/aos.js'/>"></script>
	  ...
	  <script src="<c:url value='/template/web/assets/vendor/isotope-layout/isotope.pkgd.min.js'/>"></script>
	  <script src="<c:url value='/template/web/assets/vendor/swiper/swiper-bundle.min.js'/>"></script>
	  <script src="<c:url value='/template/web/assets/vendor/waypoints/noframework.waypoints.js'/>"></script>
